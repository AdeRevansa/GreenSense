...
<head>
  ...
  <title>Riwayat - <?php echo $d->kelompok ?></title>
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card overflow-auto">
            <div class="card-body">
              <h5 class="card-title">Riwayat Laporan Data</h5>
              ...
              <table class="table datatable">
                ...
                <?php
                  if(!(isset($_POST['submit']))){
                    $no = 1;
                    $cek = mysqli_query($conn,"SELECT * FROM data_penyiraman ORDER BY tanggal DESC ");
                    while ($tampil = mysqli_fetch_array($cek)){
                    
                    $tanggal = $tampil['tanggal'];
                    $tanah = $tampil['kategori_pompa'];
                    ?>
                  <tr style="text-align:center;">
                    <td><?php echo $no++ ?></td>
                    <td><?php echo date('d F Y', strtotime($tanggal)) ?></td>
                    <td><?php echo date('H:i:s', strtotime($tanggal)) ?></td>
