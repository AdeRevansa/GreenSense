...
class FeatureExtractor:
    ...
    def extract_color_hsv(self, image_path):
        image = cv2.imread(image_path)  # Membaca gambar
        hsv_image = cv2.cvtColor(image, cv2.COLOR_BGR2HSV)  # Mengonversi ke mode warna HSV
        ...
        # Mengembalikan list dengan fitur HSV
...
# ...
    ...
    def extract_features(self, image_path):
        ...
        color_hsv = self.extract_color_hsv(image_path)  # Mengubah menjadi extract_color_hsv
    ...
    def extract_features(self, image_path):
        ...
        color_features = self.extract_color_features(image_path)
        color_hsv = self.extract_color_hsv(image_path)

        # Combine all features into a single array
        features = color_features + color_hsv
...
if __name__ == "__main__":
    ...
    data_file = "C:/xampp/htdocs/htdocs/GreenSense/ExtrasifiturGreenSense.xlsx"
    mushroom_classifier.train(data_file)

    output_file = "C:/xampp/htdocs/htdocs/GreenSense/ExtrasifiturGreenSense.xlsx"

    while True:
        sample_image_path = 'C:/xampp/htdocs/htdocs/GreenSense/CekKondisi/gambar.jpg'
